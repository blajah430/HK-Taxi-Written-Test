...
export const TAXI_REGULATIONS: Question[] = [
  ...
  { id: 'reg-19', category: 'REGULATIONS', question: '的士司機如在車內發現失物，而該失物價值超過多少，應立即送交警署？', options: ['$100', '$200', '$500', '$1,000'], answer: 2 },
...
export const ROUTES: Question[] = [
  ...
  { id: 'route-16', category: 'ROUTES', question: '由 屯門市廣場 駛至 尖沙咀海港城，最直接經哪些公路？', options: ['屯門公路及西九龍公路', '青山公路', '龍翔道', '大埔公路'], answer: 0 },
  { id: 'route-17', category: 'ROUTES', question: '由 大埔中心 駛至 觀塘創紀之城，最直接經哪條隧道？', options: ['大老山隧道', '獅子山隧道', '尖山隧道', '城門隧道'], answer: 0 },
  { id: 'route-18', category: 'ROUTES', question: '由 元朗朗屏邨 駛至 銅鑼灣時代廣場，最直接經哪條隧道？', options: ['西區海底隧道', '紅磡海底隧道', '東區海底隧道', '大欖隧道'], answer: 0 },
  { id: 'route-19', category: 'ROUTES', question: '由 將軍澳新都城 駛至 柴灣杏花邨，最直接經哪些道路？', options: ['將軍澳隧道及東區海底隧道', '紅磡海底隧道', '西區海底隧道', '觀塘繞道'], answer: 0 },
  { id: 'route-20', category: 'ROUTES', question: '由 荃灣悅來酒店 駛至 上環港澳碼頭，最直接經哪些道路？', options: ['青葵公路、西九龍公路及西區海底隧道', '青衣南橋及西九龍走廊', '龍翔道及紅磡海底隧道', '呈祥道及西區海底隧道'], answer: 0 },
  { id: 'route-21', category: 'ROUTES', question: '由 沙田第一城 駛至 尖沙咀K11，最直接經哪條隧道？', options: ['獅子山隧道', '大老山隧道', '尖山隧道', '城門隧道'], answer: 0 },
  { id: 'route-22', category: 'ROUTES', question: '由 鴨脷洲海怡半島 駛至 旺角朗豪坊，最直接經哪條隧道？', options: ['紅磡海底隧道', '西區海底隧道', '東區海底隧道', '香港仔隧道'], answer: 0 },
  { id: 'route-23', category: 'ROUTES', question: '由 柴灣小西灣邨 駛至 觀塘APM，最直接經哪條隧道？', options: ['東區海底隧道', '紅磡海底隧道', '西區海底隧道', '將軍澳隧道'], answer: 0 },
  { id: 'route-24', category: 'ROUTES', question: '由 葵涌石籬邨 駛至 尖沙咀天星碼頭，最直接經哪些街道？', options: ['葵涌道及長沙灣道', '呈祥道', '龍翔道', '大埔道'], answer: 0 },
  { id: 'route-25', category: 'ROUTES', question: '由 粉嶺名都 駛至 觀塘裕民坊，最直接經哪些道路？', options: ['吐露港公路及大老山隧道', '獅子山隧道', '大埔公路', '粉嶺公路'], answer: 0 },
  { id: 'route-26', category: 'ROUTES', question: '由 馬鞍山耀安邨 駛至 灣仔會議展覽中心，最直接經哪些道路？', options: ['大老山隧道及東區海底隧道', '獅子山隧道及紅磡海底隧道', '尖山隧道及西區海底隧道', '馬鞍山路'], answer: 0 },
  { id: 'route-27', category: 'ROUTES', question: '由 屯門良景邨 駛至 旺角始創中心，最直接經哪些道路？', options: ['屯門公路及長沙灣道', '青山公路', '龍翔道', '呈祥道'], answer: 0 },
  { id: 'route-28', category: 'ROUTES', question: '由 元朗錦綉花園 駛至 尖沙咀中港城，最直接經哪些道路？', options: ['大欖隧道及西九龍公路', '屯門公路', '青山公路', '新田公路'], answer: 0 },
  { id: 'route-29', category: 'ROUTES', question: '由 大埔太和邨 駛至 銅鑼灣崇光百貨，最直接經哪些道路？', options: ['吐露港公路及獅子山隧道', '大老山隧道', '尖山隧道', '紅磡海底隧道'], answer: 0 },
  { id: 'route-30', category: 'ROUTES', question: '由 荃灣綠楊新邨 駛至 中環國際金融中心，最直接經哪些道路？', options: ['西九龍公路及西區海底隧道', '青葵公路', '長沙灣道', '紅磡海底隧道'], answer: 0 },
  { id: 'route-31', category: 'ROUTES', question: '由 沙田新城市廣場 駛至 觀塘工業區，最直接經哪條隧道？', options: ['大老山隧道', '獅子山隧道', '尖山隧道', '城門隧道'], answer: 0 },
  { id: 'route-32', category: 'ROUTES', question: '由 藍田平田邨 駛至 銅鑼灣維多利亞公園，最直接經哪條隧道？', options: ['東區海底隧道', '紅磡海底隧道', '西區海底隧道', '啟德隧道'], answer: 0 },
  { id: 'route-33', category: 'ROUTES', question: '由 秀茂坪寶達邨 駛至 尖沙咀文化中心，最直接經哪條隧道？', options: ['啟德隧道', '東區海底隧道', '紅磡海底隧道', '大老山隧道'], answer: 2 },
  { id: 'route-34', category: 'ROUTES', question: '由 黃大仙中心 駛至 灣仔入境事務大樓，最直接經哪條隧道？', options: ['紅磡海底隧道', '西區海底隧道', '東區海底隧道', '獅子山隧道'], answer: 0 },
  { id: 'route-35', category: 'ROUTES', question: '由 深水埗富昌邨 駛至 港鐵上水站，最直接經哪些道路？', options: ['青沙公路及大埔公路', '獅子山隧道', '龍翔道', '粉嶺公路'], answer: 0 },
  { id: 'route-36', category: 'ROUTES', question: '由 青衣長亨邨 駛至 旺角花園街，最直接經哪些道路？', options: ['青葵公路及西九龍走廊', '青衣大橋', '長沙灣道', '荔枝角道'], answer: 0 },
  { id: 'route-37', category: 'ROUTES', question: '由 屯門黃金海岸 駛至 尖沙咀麼地道，最直接經哪條公路？', options: ['屯門公路', '青山公路', '龍翔道', '西九龍公路'], answer: 0 },
  { id: 'route-38', category: 'ROUTES', question: '由 元朗形點 駛至 銅鑼灣希慎廣場，最直接經哪些道路？', options: ['大欖隧道及西區海底隧道', '屯門公路及紅磡海底隧道', '林錦公路', '東區海底隧道'], answer: 0 },
  { id: 'route-39', category: 'ROUTES', question: '由 大埔大埔墟 駛至 觀塘順利邨，最直接經哪些道路？', options: ['吐露港公路及大老山隧道', '獅子山隧道', '大埔公路', '清水灣道'], answer: 0 },
  { id: 'route-40', category: 'ROUTES', question: '由 荃灣愉景新城 駛至 灣仔稅務大樓，最直接經哪條隧道？', options: ['西區海底隧道', '紅磡海底隧道', '東區海底隧道', '城門隧道'], answer: 0 },
  { id: 'route-41', category: 'ROUTES', question: '由 沙田廣源邨 駛至 尖沙咀海濱公園，最直接經哪條隧道？', options: ['獅子山隧道', '大老山隧道', '尖山隧道', '大埔公路'], answer: 0 },
  { id: 'route-42', category: 'ROUTES', question: '由 鴨脷洲利東邨 駛至 旺角新世紀廣場，最直接經哪條隧道？', options: ['紅磡海底隧道', '西區海底隧道', '東區海底隧道', '香港仔隧道'], answer: 0 },
  { id: 'route-43', category: 'ROUTES', question: '由 柴灣興華邨 駛至 觀塘翠屏邨，最直接經哪條隧道？', options: ['東區海底隧道', '紅磡海底隧道', '西區海底隧道', '將軍澳隧道'], answer: 0 },
  { id: 'route-44', category: 'ROUTES', question: '由 葵涌安蔭邨 駛至 尖沙咀廣東道，最直接經哪條道路？', options: ['葵涌道', '呈祥道', '龍翔道', '大埔道'], answer: 0 },
  { id: 'route-45', category: 'ROUTES', question: '由 粉嶺華明邨 駛至 觀塘開源道，最直接經哪條隧道？', options: ['大老山隧道', '獅子山隧道', '尖山隧道', '粉嶺公路'], answer: 0 }
];

export const ROAD_CODE: Question[] = [
  { id: 'road-1', category: 'ROAD_CODE', question: '駛過水浸的街道後，你應：', options: ['閃動車頭燈警告迎面車輛', '響號警告尾隨車輛', '立即試驗煞車系統的性能'], answer: 2 },
  { id: 'road-2', category: 'ROAD_CODE', question: '若用以豎立「不准停車」標誌的標誌杆為紅色則代表何時不准停車？', options: ['上午七時至下午七時', '上午七時至十時及下午四時至七時', '上午七時至午夜十二時'], answer: 2 },
  { id: 'road-3', category: 'ROAD_CODE', question: '電單車後座（側車固定座位除外），不可以運載少於多少歲的乘客？', options: ['8歲', '10歲', '12歲'], answer: 0 },
  { id: 'road-4', category: 'ROAD_CODE', question: '在薄霧天氣下，看到「道路工程」標誌時，你應：', options: ['以正常車速駛經工地', '慢駛，與前車保持安全距離，並提防在工地或附近有人員突然走近', '立即停車，並切勿駛越這標誌'], answer: 1 },
  { id: 'road-5', category: 'ROAD_CODE', question: '黃色虛線代表什麼？', options: ['不准停車', '不准泊車', '在指定時間內不准停車'], answer: 2 },
  { id: 'road-6', category: 'ROAD_CODE', question: '雙黃線代表什麼？', options: ['任何時間不准停車', '指定時間不准停車', '可以短暫上落客'], answer: 0 },
  { id: 'road-7', category: 'ROAD_CODE', question: '「停」字交通標誌的形狀是：', options: ['圓形', '三角形', '八角形'], answer: 2 },
  { id: 'road-8', category: 'ROAD_CODE', question: '在快速公路上，除非正在超越前車，否則應在：', options: ['最左線行駛', '最右線行駛', '中間線行駛'], answer: 0 },
  { id: 'road-9', category: 'ROAD_CODE', question: '看到紅燈閃動時，你應：', options: ['慢駛', '停車', '立即停車，除非會引起危險'], answer: 1 },
  { id: 'road-10', category: 'ROAD_CODE', question: '在隧道內，你必須：', options: ['亮著車頭燈', '亮著危險警告燈', '不斷響號'], answer: 0 },
  { id: 'road-11', category: 'ROAD_CODE', question: '當你看到「讓」字標誌時，你應：', options: ['立即停車', '減速並準備讓路給主要道路的車輛', '加速通過'], answer: 1 },
  { id: 'road-12', category: 'ROAD_CODE', question: '在斑馬線前，如有行人已踏足其上，你必須：', options: ['響號警告', '停車讓行人過路', '加速通過'], answer: 1 },
  { id: 'road-13', category: 'ROAD_CODE', question: '酒精測試如超過多少，即屬違法？', options: ['每100毫升呼氣中有22微克', '每100毫升呼氣中有33微克', '每100毫升呼氣中有50微克'], answer: 0 },
  { id: 'road-14', category: 'ROAD_CODE', question: '在夜間行車，當迎面有車輛駛近時，你應：', options: ['亮著遠光燈', '轉用近光燈', '關掉所有燈光'], answer: 1 },
  { id: 'road-15', category: 'ROAD_CODE', question: '看到「禁止進入」標誌（紅底白橫槓），代表：', options: ['禁止所有車輛進入', '禁止行人進入', '禁止單車進入'], answer: 0 },
  { id: 'road-16', category: 'ROAD_CODE', question: '在快速公路上，私家車的最高限速通常是：', options: ['70公里/小時', '80公里/小時', '100或110公里/小時'], answer: 2 },
  { id: 'road-17', category: 'ROAD_CODE', question: '當救護車亮著警號駛近時，你應：', options: ['加速避開', '在安全情況下盡快讓路', '立即在路中心停車'], answer: 1 },
  { id: 'road-18', category: 'ROAD_CODE', question: '輪胎的胎紋深度不得少於：', options: ['1毫米', '1.6毫米', '2毫米'], answer: 0 },
  { id: 'road-19', category: 'ROAD_CODE', question: '在雨天行車，煞車距離會：', options: ['減少', '不變', '增加至少一倍'], answer: 2 },
  { id: 'road-20', category: 'ROAD_CODE', question: '看到黃色方格路口，除非你能完全駛出該路口，否則：', options: ['可以進入', '不得進入', '可以停在格內'], answer: 1 },
  { id: 'road-21', category: 'ROAD_CODE', question: '在單程路上，你應：', options: ['隨意掉頭', '順著交通方向行駛', '可以逆線短距離行駛'], answer: 1 },
  { id: 'road-22', category: 'ROAD_CODE', question: '看到斜線區域（影線），你：', options: ['可以橫過', '除非緊急情況，否則不得進入', '可以泊車'], answer: 1 },
  { id: 'road-23', category: 'ROAD_CODE', question: '在迴旋處，你應讓路給：', options: ['左方車輛', '右方已在迴旋處內的車輛', '後方車輛'], answer: 1 },
  { id: 'road-24', category: 'ROAD_CODE', question: '看到藍色圓形標誌，代表：', options: ['警告標誌', '強制性標誌（必須遵守）', '資訊標誌'], answer: 1 },
  { id: 'road-25', category: 'ROAD_CODE', question: '看到紅色三角形標誌，代表：', options: ['警告標誌', '禁令標誌', '指示標誌'], answer: 0 },
  { id: 'road-26', category: 'ROAD_CODE', question: '在夜間泊車，如街道沒有足夠照明，你應：', options: ['關掉所有燈', '亮著泊車燈', '亮著遠光燈'], answer: 1 },
  { id: 'road-27', category: 'ROAD_CODE', question: '當你感到疲倦時，你應：', options: ['喝咖啡繼續開車', '找安全地方停車休息', '加速回家'], answer: 1 },
  { id: 'road-28', category: 'ROAD_CODE', question: '在快速公路上，如發生故障，你應：', options: ['停在行車線上', '盡可能駛入路肩或避車處', '立即下車在路中心檢查'], answer: 1 },
  { id: 'road-29', category: 'ROAD_CODE', question: '看到行人過路燈綠燈閃動，代表：', options: ['行人可以開始過路', '行人不可開始過路，已在路上的應盡快完成', '行人必須跑過馬路'], answer: 1 },
  { id: 'road-30', category: 'ROAD_CODE', question: '在斜坡泊車，除了拉緊手掣外，還應：', options: ['關掉引擎', '入一檔（上坡）或倒檔（下坡）', '以上皆是'], answer: 2 },
  { id: 'road-31', category: 'ROAD_CODE', question: '看到「禁止掉頭」標誌，代表：', options: ['可以掉頭', '不准掉頭', '只准左轉'], answer: 1 },
  { id: 'road-32', category: 'ROAD_CODE', question: '在隧道內發生火警，你應：', options: ['留在車內關窗', '熄火留匙，按指示逃生', '嘗試掉頭駛出'], answer: 1 },
  { id: 'road-33', category: 'ROAD_CODE', question: '看到綠色箭頭燈亮著，代表：', options: ['所有方向均可通行', '只准朝箭頭方向通行', '必須停車'], answer: 1 },
  { id: 'road-34', category: 'ROAD_CODE', question: '在濃霧中行車，你應亮著：', options: ['遠光燈', '霧燈及近光燈', '室內燈'], answer: 1 },
  { id: 'road-35', category: 'ROAD_CODE', question: '看到「禁止鳴喇叭」標誌，除非為了警告危險，否則：', options: ['可以隨便鳴喇叭', '不准鳴喇叭', '只准在日間鳴喇叭'], answer: 1 },
  { id: 'road-36', category: 'ROAD_CODE', question: '看到黃色虛線，代表：', options: ['不准停車', '不准泊車', '在指定時間內不准停車'], answer: 2 },
  { id: 'road-37', category: 'ROAD_CODE', question: '看到紅色圓圈標誌（中間空白），代表：', options: ['禁止所有車輛進入', '禁止行人進入', '禁止單車進入'], answer: 0 },
  { id: 'road-38', category: 'ROAD_CODE', question: '在夜間，如你被後車燈光刺眼，你應：', options: ['加速', '減速或停車，直到視線恢復', '亮著遠光燈報復'], answer: 1 },
  { id: 'road-39', category: 'ROAD_CODE', question: '當你駛近學校時，你應：', options: ['加速通過', '減速並準備隨時停車', '不斷響號'], answer: 1 },
  { id: 'road-40', category: 'ROAD_CODE', question: '看到「禁止泊車」標誌，代表：', options: ['不准停車', '不准泊車，但可短暫上落客', '不准進入'], answer: 1 }
];
